...
def train_ensemble(encoders, heads, ensemble, train_dataloader, valid_dataloader, total_epochs, early_stop=False, optimtype=torch.optim.RMSprop, 
...
def single_test_ensemble(model, test_dataloader, auprc=False, task='classification', criterion=None, save_preds=None, save_acc=False):
...
def test_ensemble(model, test_dataloaders_all, dataset='default', method_name='My method', auprc=False, task='classification', criterion=None, no_robust=False, save_preds=None, save_acc=None):
