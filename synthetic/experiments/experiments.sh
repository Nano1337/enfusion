...
do
    ...
    # late fusion-avg
    echo additive
    python synthetic/additive.py --data-path synthetic/experiments/DATA_${setting}.pickle --keys 0 1 label --bs 256 --input-dim 64 --output-dim 600 --hidden-dim 20 --num-classes 32 --saved-model synthetic/experiments/${setting}/${setting}_additive_best.pt --setting ${setting} --out_dir synthetic/experiments/${setting} > synthetic/experiments/${setting}/${setting}_additive.txt
