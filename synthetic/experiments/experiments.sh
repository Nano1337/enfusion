...
do
    ...
    echo ensemble
    python synthetic/actual_ensemble.py --data-path synthetic/experiments/DATA_${setting}.pickle --keys 0 1 label --bs 256 --input-dim 200 --output-dim 600 --hidden-dim 512 --num-classes 2 --saved-model synthetic/experiments/${setting}/${setting}_ensemble_best.pt --setting ${setting} --out_dir synthetic/experiments/${setting} --seed ${seed} > synthetic/experiments/${setting}/${setting}_ensemble_${seed}.txt
